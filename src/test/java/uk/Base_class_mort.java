...
public class Base_class_mort {
	...
	@BeforeTest
	@Parameters({"deviceID"})
	public void Launch_App(String deviceID) throws MalformedURLException, InterruptedException
	{
		...
		{
			System.out.println("Execting in Device1");
		...
		{
			System.out.println("Execting in Device2");
