...
//		WebElement ele_Addcart = wait2.until(ExpectedConditions.presenceOfElementLocated(By.id("com.flipkart.android:id/product_addtocart_1")));
//		System.out.println("Add cart button is found "+ele_Addcart.isDisplayed());
//		
//		ele_Addcart.click();
//		Thread.sleep(7000);
//		
...
//		Thread.sleep(12000);
//		
//		driver.findElementByXPath("//*[@index='0'][@text='GO TO CART'][@resource-id='com.flipkart.android:id/product_addtocart_1']").click();
//			Thread.sleep(10000);
//		
